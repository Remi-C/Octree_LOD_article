# -*- coding: utf-8 -*-
"""
Created on Wed Feb 10 15:53:24 2016
...
def process_one_gid(one_gid, conn, cur, connection_string):
    ...
    import rc_ppl_octree as ppl
    import numpy as np
    #get data
    
    q = """ SELECT pc_uncompress(patch),8 AS patch   
    ...
    restrict_dim = ["x","y","z"] 
    points_double, mschema = pgp.WKB_patch_to_numpy_double(u_patch, GD['rc']['schemas'], connection_string, dim_to_use=restrict_dim)
    
    #processnig :
    ppl_octree = ppl.pointcloud_to_ppl(points_double,tot_level)
    ...
    q = """ UPDATE lod.dim_descr_comparison
        ...
        WHERE gid = %s; """
    arg_list = [ppl_octree.tolist(),one_gid]
