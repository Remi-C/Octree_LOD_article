...
\end{figure*} 
	...
	\subsection{Related Work} 
		...
		Bereuter2015 : using quad tree to generalise points, 4 types of generalisation : selection, simplification, aggregation, displacement
	    ...
	    \todoall{citer  Baert2014 , pour les considérations off line d'octree enormes}
	    
	    
	    
		%Indeed LOD approaches sacrifices a part of information in exchange of a massive reduction of data size which is necessary for efficient usage/visualisation. In this regard, a LOD method must by nature be efficient, or the information loss would be pointless.
