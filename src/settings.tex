...
%%Useful
	...
	%defining new command for image insertion
		\newcommand{\myimage}[2]
					...
					\begin{figure} [!h]
						\begin{center}
							\fbox{\includegraphics[width=\textwidth/2,keepaspectratio]{#1}}
							\caption{} 
							\end{center}
					\end{figure} 
					}
		\newcommand{\myimageFullPageHeight}[2]
						{
						\begin{figure*} [!h]
							\begin{center}
								\fbox{\includegraphics[height=\textheight,keepaspectratio ]{#1}}
								\caption{} 
								\end{center}
						\end{figure*} 
						}
		\newcommand{\myimageFullPageWidth}[2]
								{
								\begin{figure*} [!h]
									\begin{center}
