 ...
 \section{ Discussion }
	...
	\subsubsection{Classification results}
		 ...
		 \subsubsection{Precision or Recall increase}
			...
			\myimage{./illustrations/classif/result_paris/4_plus_wheelers_precision_vs_confidence.pdf}{Precision of 4+wheelers class = f(random forest confidence score).}{fig:precision-vs-confidence} 
