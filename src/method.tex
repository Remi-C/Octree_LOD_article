...
\section{Method}
	...
	\subsection{Exploiting the order of points}
		...
		%\subsubsection{Principle} 
			...
			\myimage{./illustrations/chap2/LOD/short_illustration_concept_lod/concept_Level_Of_Detail.png}{3 geometrical Level Of Detail (LOD) for the same point cloud. Starting from very low detail by reading the first point of the patch, reading further points increases the details.}{lod.fig:lod-principle}
	...
	\subsection{MidOc : an ordering for gradual geometrical approximation}
		...
		\myimage{./illustrations/chap2/intralevel_ordering/intralevel_ordering_combined}{Several possible orders with various coverage from bad to good. Revert Morton and Revert Hilbert have offset for illustration.}{lod.fig:intralevel_ordering}
