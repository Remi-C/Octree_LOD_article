...
%	 	 
	...
	\subsection{ MidOc : an ordering for gradual geometrical approximation}
		...
		\myimage{./illustrations/intralevel_ordering/intralevel_ordering_combined}{Several possible orders with coverage from bad to good.}{fig:intralevel_ordering}
	...
	\subsection{Using the ordering by-product as a crude dimensionality descriptor}
		...
		\subsubsection{Principle}
			...
			\myimage{"./illustrations/dim_descriptor/dim_descriptor"}{Crude dimensionality descriptor by voxel occupancy.}{fig:dim_descriptor}
