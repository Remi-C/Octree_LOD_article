...
\section{Method}
	...
	\subsection{the Point Cloud Server}
		summing up the PCS system (only the feature we are interested in).
		concept : store points as group
		powerful index on those groups
		I/O fast.
		coupling with other GIS data.
